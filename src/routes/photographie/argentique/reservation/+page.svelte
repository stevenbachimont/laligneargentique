              ...
              <div class="parcours-map">
                ...
                <div class="map-content">
                  <div class="map-route">
                    {#each getParcoursSteps(balade) as step, index}
                      <div class="route-step" style="animation-delay: {index * 0.1}s">
                        ...
                        {#if index < getParcoursSteps(balade).length - 1}
                  ...
                  <div class="map-legend">
                    ...
                    <div class="legend-item">
                      <div class="legend-marker step"></div>
...
<style>
  ...
  .route-step:first-child .step-marker {
    background: linear-gradient(45deg, #00ff00, #00cc00);
    border: 3px solid #fff;
  }

  .route-step:last-child .step-marker {
    background: linear-gradient(45deg, #ff6b6b, #ff4757);
    border: 3px solid #fff;
  }

  .route-step:not(:first-child):not(:last-child) .step-marker {
    background: linear-gradient(45deg, #ffd700, #ffed4e);
    border: 3px solid #fff;
  }
